...
class TicTacToe(Frame):
    ...
    def create_grid(self):
        ...
        self.canvas.create_rectangle(10, 10, 110, 105, fill="cyan2",
                                     width='0', tags=tag1)
        self.canvas.create_rectangle(118, 10, 220, 105, fill="cyan2",
                                     width='0', tags=tag2)
        self.canvas.create_rectangle(230, 10, 325, 105, fill="cyan2",
                                     width='0', tags=tag3)
        self.canvas.create_rectangle(10, 115, 110, 215, fill="cyan2",
                                     width='0', tags=tag4)
        self.canvas.create_rectangle(118, 115, 220, 215, fill="cyan2",
                                     width='0', tags=tag5)
        self.canvas.create_rectangle(230, 115, 325, 215, fill="cyan2",
                                     width='0', tags=tag6)
        self.canvas.create_rectangle(10, 225, 110, 325, fill="cyan2",
                                     width='0', tags=tag7)
        self.canvas.create_rectangle(118, 225, 220, 325, fill="cyan2",
                                     width='0', tags=tag8)
        self.canvas.create_rectangle(230, 225, 325, 325, fill="cyan2",
                                     width='0', tags=tag9)
        self.canvas.tag_bind(tag1, "<Button-1>", lambda event,
                                 tag=tag1: self.clicked(event, tag))
        self.canvas.tag_bind(tag2, "<Button-1>", lambda event,
                                 tag=tag2: self.clicked(event, tag))
        self.canvas.tag_bind(tag3, "<Button-1>", lambda event,
                                 tag=tag3: self.clicked(event, tag))
        self.canvas.tag_bind(tag4, "<Button-1>", lambda event,
                                 tag=tag4: self.clicked(event, tag))
        self.canvas.tag_bind(tag5, "<Button-1>", lambda event,
                                 tag=tag5: self.clicked(event, tag))
        self.canvas.tag_bind(tag6, "<Button-1>", lambda event,
                                 tag=tag6: self.clicked(event, tag))
        self.canvas.tag_bind(tag7, "<Button-1>", lambda event,
                                 tag=tag7: self.clicked(event, tag))
        self.canvas.tag_bind(tag8, "<Button-1>", lambda event,
                                 tag=tag8: self.clicked(event, tag))
        self.canvas.tag_bind(tag9, "<Button-1>", lambda event,
                                 tag=tag9: self.clicked(event, tag))
